...
On average, participants chose `r data_descr[,apa_mean_conf(prop_choices), by = .(chosen_item)][,paste_and(sprintf('%ss in %s', chosen_item, V1))]`% of trials (here and later the confidence intervals are reported in square brackets after the means). Response times were `r data_descr[,apa_mean_conf(mean_RT), by = .(chosen_item)][,paste_and(V1)]`, respectively. 
