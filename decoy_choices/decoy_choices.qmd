...
### Data Collection
The experiment recorded the following data for each trial:
- Trial parameters (condition, correct option, set type, decoy type, target-to-competitor difference, decoy reduction, decoy placement)
- Participant response (1, 2, or 3)
- Response accuracy (whether the participant selected the target option)
- Response time
- Positions and values of all options presented
