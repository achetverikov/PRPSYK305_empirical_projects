...
title_code_matching <- data.frame(
  ...
  study_name = c(
    "JATOS_COLORS_AND_IMAGERY_STUDY_2026_UID",
    "JATOS_TEMP_ATT_STUDY_UID",
    "JATOS_DECOY_STUDY_2026_UID",
    "JATOS_TOMATO_STUDY_2026_UID",
    "JATOS_OBJ_STUDY_UID",
...
study_uids <- study_uids[names(study_uids)%in% title_code_matching$study_name]
