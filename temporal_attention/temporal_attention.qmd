...
ggplot(data, aes(x = diff_to_next, y = error, color = factor(real_target_position)))+geom_smooth()+gg_crosshair()
ggplot(data, aes(x = diff_to_prev, y = error, color = factor(real_target_position)))+geom_smooth()+gg_crosshair()
```
