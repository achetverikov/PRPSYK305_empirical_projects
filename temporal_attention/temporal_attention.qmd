...
fwrite(data, file = 'temporal_attention.csv')
```
...
- Trial parameters (target position, cue type)
- Orientations of all three Gabor patches
- Initial and post-cue sound files played
- Response orientation
- Angular error (difference between response and target orientations)
