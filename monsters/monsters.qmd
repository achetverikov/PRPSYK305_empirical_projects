...
plot.pointrange(data[correct==1&trial_i_within_block_rel%between%c(-2,2)], aes(x = trial_i_within_block_rel, y = mouse_first_move_time , color = expected_lengthf ), wid = 'participant', within_subj = F, withinvars=c('trial_i_within_block_rel','expected_lengthf'), do_aggregate = F)

plot.pointrange(data[trial_i_within_block==1], aes(x = prevLengthDiff, y = mouse_first_move_time ), wid = 'participant', within_subj = F, do_aggregate = F)
