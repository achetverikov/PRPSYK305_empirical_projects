...
## Participants
`r str_to_sentence(apastats:::numbers2words(finished_study_ids[,.N]))` participants took part in the study. `r str_to_sentence(apastats:::numbers2words(finished_study_ids[,.N]-data[,lengthu(participant)]))` participant was excluded because they had zero correct responses. Participation required a web browser with a minimum screen resolution of 1000 × 600 pixels. Demographic information was not collected.
